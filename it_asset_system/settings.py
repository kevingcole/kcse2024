"""
Django settings for it_asset_system project.
...
SECRET_KEY = 'django-insecure-=6tbo_19&#vdzov0!o@_@4j&ja4kg+i3%(iqgi3z39&s!nw))@'
...
ROOT_URLCONF = 'it_asset_system.urls'
...
WSGI_APPLICATION = 'it_asset_system.wsgi.application'
